...
//         scrollSpy = jest.spyOn(scrollService, 'scroll').mockImplementation(jest.fn);
//         scrollToTopSpy = jest.spyOn(scrollService, 'scrollToTop').mockImplementation(jest.fn);
//       });
//
...
//         const updateSideNavSpy = jest.spyOn(component, 'updateSideNav').mockImplementation(jest.fn);
//
//         triggerDocViewerEvent('docReady');
